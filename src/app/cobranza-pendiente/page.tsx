    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="bi-card border-l-4 border-l-[#C00000] p-3">
          ...
          <div className="text-2xl font-bold text-[#C00000] font-lato">{fmt(totalPendiente)}</div>
        ...
        <div className="bi-card border-l-4 border-l-[#375623] p-3">
          ...
          <div className="text-2xl font-bold text-[#375623] font-lato">{fmt(porVencer)}</div>
            ...
            {data.map((r, i) => (
              <tr
                ...
                className={`border-b border-[#F0F0F0] hover:bg-[#FFF5F5] transition-colors ${
                  r.dias_vencido > 30 ? "bg-[#FFF2F2]" : i % 2 === 1 ? "bg-[#FAFAFA]" : ""
                }`}
              >
                ...
                <td className={`px-3 py-1.5 text-right font-medium ${r.dias_vencido > 30 ? "text-[#C00000] font-bold" : ""}`}>
                  {r.dias_vencido}
                </td>
